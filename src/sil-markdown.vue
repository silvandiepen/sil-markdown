...
export default {
	md: new markdownIt(),
	template: '<component :is="element" class="markdown"><slot></slot></component>',
	...
	render(createElement, context) {
		...
		if (this.$props.meta) {
			return createElement(this.$props.element, this.metaData);
		} else {
			return createElement(this.$props.element, {
				domProps: {
					innerHTML: this.$props.unp ? outHtml.replace('<p>','').replace('</p>','') : outHtml
				}
			});
		}
	},
